...
<html lang="da">
  <head>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" name="colorname" value="Sort">&nbsp<input type="text" value="#000000" name="hex[]"/><a href="#" class="remove_field">&nbspFjern</a></div>'); //add input box
        }
    });
 ...
 <script>
      var theInput = document.getElementById("cpButton");
